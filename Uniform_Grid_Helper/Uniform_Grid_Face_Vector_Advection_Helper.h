...
class Uniform_Grid_Face_Vector_Advection_Helper
{
  ...
  public:
    Uniform_Grid_Face_Vector_Advection_Helper(Hierarchy& hierarchy,const std::pair<const uint64_t*,unsigned>& blocks,Channel_Vector& face_vector_channels,Channel_Vector& node_vector_channels,Channel_Vector& face_velocity_channels,Channel_Vector& node_velocity_channels,
