...
class Uniform_Grid_Advection_Helper
{
  ...
  public:
    static void Uniform_Grid_Advect_Density(Hierarchy& hierarchy,Channel_Vector& node_velocity_channels,T Struct_type::* density_channel,
                               T Struct_type::* temp_channel,const T dt)
    {
        ...
        // advect
        for(int level=0;level<levels;++level)
            Uniform_Grid_Density_Advection_Helper<Struct_type,T,d>(hierarchy,hierarchy.Blocks(level),density_channel,temp_channel,node_velocity_channels,
