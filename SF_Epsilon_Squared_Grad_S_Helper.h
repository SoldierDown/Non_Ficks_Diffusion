//!#####################################################################
//! \file SF_Epsilon_Squared_Grad_S_Helper.h
//!#####################################################################
// Class SF_Epsilon_Squared_Grad_S_Helper
//######################################################################
#ifndef __SF_Epsilon_Squared_Grad_S_Helper__
#define __SF_Epsilon_Squared_Grad_S_Helper__
...
class SF_Epsilon_Squared_Grad_S_Helper
{
  ...
  public:
    SF_Epsilon_Squared_Grad_S_Helper(Allocator_type& allocator,const std::pair<const uint64_t*,unsigned>& blocks,Channel_Vector& face_qs_channels,
            ...
            T Struct_type::* epsilon_channel,T Struct_type::* density_backup_channel,const T minus_dt_over_tau_1,const TV one_over_dx,const int level) const
    {
        ...
        auto sf_epsilon_squared_grad_s_helper=[&](uint64_t offset)
        {
        ...
        SPGrid_Computations::Run_Parallel_Blocks(blocks,sf_epsilon_squared_grad_s_helper);
    }
};
}
#endif
